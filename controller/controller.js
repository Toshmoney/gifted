...
//     // Fetch user accounts and wallet details
//     const userAcc = await User.findOne({ email });
//     const transUser = req.user;
//     const user = userAcc._id;
//     const transUserWallet = await Wallet.findOne({ user: transUser._id });
//     const name = userAcc.name;
//     let wallet = await Wallet.findOne({ user: transUser._id });
...
//     if (transUserWallet.current_balance < Number(amount)) {
...
//       type: "debit",
//       status: "pending",
//       description: `NGN ${amount} Transfered to ${userAcc.username}`,
//       reference_number: "manual-funding",
//     });

//     const usertransaction = new Transaction({
//       user: userAcc,
//       balance_before: transUserWallet.previous_balance,
//       balance_after: transUserWallet.current_balance,
//       amount: amount,
//       service: "wallet",
//       type: "debit",
//       status: "pending",
//       description: `NGN ${amount} Transfered from ${transUser.username}`,
//       reference_number: "manual-trans-funding",
//     });
...
//       text: `Dear ${name}, your account has been credited NGN${amount} from ${transUser.username}!`,
//     };
...
//     wallet.current_balance = userAcc.balance - amount_paid;
//     transUserWallet.current_balance = transUserWallet.current_balance + amount_paid;
//     usertransaction.status = "completed"
//     transaction.status = "completed";
//     transaction.balance_after = wallet.current_balance - amount_paid;
//     usertransaction.balance_after = wallet.current_balance + amount_paid;

//     // Save changes to the database
//     await wallet.save();
//     await transaction.save();
//     await usertransaction.save();
//     await transUserWallet.save();

//     req.flash("info", "Transfer successful, User will now get credited!");
//     return res.redirect("/transfer-to-friends");
//   } catch (error) {
